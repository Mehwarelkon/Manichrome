...
export class Vector{
    constructor({main,point1,point2,color=Color(0,0,0,1),thick=2,tipSize=3}){
        this.point1=point1;
	        this.point2=point2;  
        this.color=color;
        this.thick=thick;
    ...
    draw(){
        ...
        this.main.ctx.moveTo(...this.point1.devFix())//this.point1[0]+window.innerWidth/2,-this.point1[1]+window.innerHeight/2);
       // this.main.ctx.lineTo(this.point2[0]+window.innerWidth/2,-this.point2[1]+window.innerHeight/2);
        this.main.ctx.lineTo(this.point1[0]+(r-this.tipSize)*Math.cos(phi)+window.innerWidth/2,-this.point1[1]-(r-this.tipSize)*Math.sin(phi)+window.innerHeight/2);
